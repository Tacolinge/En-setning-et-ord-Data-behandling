...
# kalkulerer vansklighetsgrad utifra legnden til ordet, frekevs fra avisartiklene, om example har innhold og lengden på example.
# målet er: jo høyere DifficultLevel jo lettere ord.
freq_file = r"frequency.json"
word_file = r"cleanWordDataBm.json"
